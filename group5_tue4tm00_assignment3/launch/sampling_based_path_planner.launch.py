...
def generate_launch_description():
    ...
    default_config = os.path.join(get_package_share_directory('group5_tue4tm00_assignment3'), 'config', 'sampling_based_path_planner.yaml') 
    ...
    path_planner_node = Node(
        ...
        executable='sampling_based_path_planner.py',
        name='path_planner',
